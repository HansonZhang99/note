...
```shell
     0 insmod(27183):        -> __class_register
     0 insmod(27183):    -> __class_create
     0 insmod(27183):    -> device_create
     0 insmod(27183):        -> device_create_groups_vargs
     0 insmod(27183):            -> device_initialize
     0 insmod(27183):                -> device_pm_sleep_init
     0 insmod(27183):                -> device_pm_sleep_init
     0 insmod(27183):                -> pm_runtime_init
     0 insmod(27183):                -> pm_runtime_init
     0 insmod(27183):            -> device_initialize
     0 insmod(27183):            -> device_add
     0 insmod(27183):                -> device_private_init
     0 insmod(27183):                -> device_private_init
     0 insmod(27183):                -> get_device_parent
     0 insmod(27183):                    -> class_dir_child_ns_type
     0 insmod(27183):                    -> class_dir_child_ns_type
     0 insmod(27183):                -> get_device_parent
     0 insmod(27183):                -> class_dir_child_ns_type
     0 insmod(27183):                -> class_dir_child_ns_type
     0 insmod(27183):                -> device_create_file
     0 insmod(27183):                -> device_create_file
     0 insmod(27183):                -> bus_add_device
     0 insmod(27183):                -> bus_add_device
     0 insmod(27183):                -> dpm_sysfs_add
     0 insmod(27183):                -> dpm_sysfs_add
     0 insmod(27183):                -> device_pm_add
     0 insmod(27183):                    -> device_pm_check_callbacks
     0 insmod(27183):                        -> pm_ops_is_empty
     0 insmod(27183):                        -> pm_ops_is_empty
     0 insmod(27183):                    -> device_pm_check_callbacks
     0 insmod(27183):                -> device_pm_add
     0 insmod(27183):                -> device_create_file
     0 insmod(27183):                -> device_create_file
     0 insmod(27183):                -> devtmpfs_create_node
     0 insmod(27183):                    -> device_get_devnode
     0 insmod(27183):                    -> device_get_devnode
     0 kdevtmpfs(13):    -> vfs_mknod
     0 kdevtmpfs(13):        -> vfs_mknod
     0 kdevtmpfs(13):            -> shmem_mknod#create device node in /dev (devtmpfs)，测试屏蔽这里的devtmpfs_create_node，下面的udev调用也无法创建/dev下设备节点
     0 kdevtmpfs(13):            -> shmem_mknod
     0 kdevtmpfs(13):        -> vfs_mknod
     0 kdevtmpfs(13):    -> vfs_mknod
     0 udevd(188):    -> __pm_relax
     0 udevd(188):    -> __pm_relax
     0 udevd(188):    -> __pm_relax
     0 udevd(188):    -> __pm_relax
     0 udevd(188):    -> __pm_relax
     0 udevd(188):    -> __pm_relax
     0 insmod(27183):                -> devtmpfs_create_node
     0 insmod(27183):                -> dev_uevent_filter
     0 insmod(27183):                -> dev_uevent_filter
     0 insmod(27183):                -> dev_uevent_name
     0 insmod(27183):                -> dev_uevent_name
     0 insmod(27183):                -> dev_uevent
     0 insmod(27183):                    -> device_get_devnode
     0 insmod(27183):                    -> device_get_devnode
     0 insmod(27183):                -> dev_uevent
     0 insmod(27183):                -> class_dir_child_ns_type
     0 insmod(27183):                -> class_dir_child_ns_type
     0 insmod(27183):                -> bus_probe_device
     0 insmod(27183):                -> bus_probe_device
     0 insmod(27183):                -> klist_class_dev_get
     0 insmod(27183):                    -> get_device
     0 insmod(27183):                    -> get_device
     0 insmod(27183):                -> klist_class_dev_get
     0 insmod(27183):            -> device_add
     0 insmod(27183):        -> device_create_groups_vargs
     0 insmod(27183):    -> device_create
     0 udevd(27184):    -> __pm_relax
     0 udevd(27184):    -> __pm_relax
     0 udevd(27184):    -> dev_attr_show
     0 udevd(27184):        -> uevent_show
     0 udevd(27184):            -> dev_uevent_filter
     0 udevd(27184):            -> dev_uevent_filter
     0 udevd(27184):            -> dev_uevent
     0 udevd(27184):                -> device_get_devnode
     0 udevd(27184):                -> device_get_devnode
     0 udevd(27184):            -> dev_uevent
     0 udevd(27184):        -> uevent_show
     0 udevd(27184):    -> dev_attr_show
     0 udevd(27184):    -> shmem_mknod#这里是kobject_uevent导致用户层的udev 调用了 mknod。但是测试发现即使在device_add中屏蔽kobject_uevent，/dev下的设备节点也能被正常创建
     0 udevd(27184):    -> shmem_mknod
     0 udevd(27184):    -> dev_attr_show
     0 udevd(27184):        -> uevent_show
     0 udevd(27184):            -> dev_uevent_filter
     0 udevd(27184):            -> dev_uevent_filter
...
以下是mknod系统调用在内核中的执行路径，应用程序仅仅调用此接口创建一个设备节点：

```shell
     0 mknodTest(4530):    -> SyS_mknod
     0 mknodTest(4530):        -> SyS_mknodat
     0 mknodTest(4530):            -> vfs_mknod
     0 mknodTest(4530):                -> vfs_mknod
     0 mknodTest(4530):                    -> shmem_mknod
     0 mknodTest(4530):                    -> shmem_mknod
     0 mknodTest(4530):                -> vfs_mknod
     0 mknodTest(4530):            -> vfs_mknod
     0 mknodTest(4530):        -> SyS_mknodat
...
由此可知，devtmpfs_create_node和mknod系统调用都会调用vfs_mknod函数，这个函数最后会在/dev下创建设备节点。





在上面的led驱动中，在用户层面，device_create主要提供两个功能：

1. 通过最后调用的device_add->devtmpfs_create_node函数创建/dev设备节点。用户通过io系统调用可以控制设备行为
2. 通过设备模型，在/sys下创建目录，这些目录下的文件可以用来观察和调试设备



在这里，两种方法都可以访问设备，只使用/dev设备节点访问设备时，可以不去调用device_create函数，而是在驱动程序中调用cdev_add注册字符设备并insmod安装驱动后，手动调用mknod系统调用或者shell命令去创建设备节点，这里需要注意内核中字符设备注册时使用的主次设备号要和调用mknod时指定是是一样的，不然open时无法通过内核全局映射找到对应的file_operations结构体



也可以使用/sys目录访问设备，这样需要调用device_add将设备注册到sysfs文件系统，并编写属性文件，在为属性文件提供的show/store函数中对设备进行具体的操作。
