...
使用工具配置lcd引脚，将配置生成的设备树拷贝到内核设备树中

需要配置的节点如下：

![image-20230529190746731](https://gitee.com/zhanghang1999/typora-picture/raw/master/image-20230529190746731.png)

配置后生成的pinctrl设备树节点如下：
...
![image-20230529010107725](https://gitee.com/zhanghang1999/typora-picture/raw/master/image-20230529010107725.png)

![image-20230529010409632](https://gitee.com/zhanghang1999/typora-picture/raw/master/image-20230529010409632.png)

## lcd控制器配置

根据datasheet对lcd寄存器进行配置
...
&pwm1 {
    ...
    status = "disabled";#禁用此节点，和lcd背光gpio冲突了
};
&lcdif {
    pinctrl-names = "default";
